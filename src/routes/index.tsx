          ...
          <div className="about-layout">
            ...
            <div className="about-copy" data-reveal>
              <p className="large-copy">
                I&apos;m currently studying Software Engineering at SMK Telkom Jakarta, splitting my
                time between coursework, hands-on IT support work, and personal coding projects on
                the side.
              </p>
              <p>
        ...
        <section id="projects" className="section projects-section">
          ...
          <div className="coming-soon-card" data-reveal>
            ...
            <div className="coming-soon-copy">
              <span className="project-status">Currently building</span>
              <h3>
                My next project is
                <br />
                coming soon.
              ...
              <p>
                I&apos;m putting the finishing touches on something that blends thoughtful design
                with solid engineering. Stay tuned.
              </p>
            </div>
